...
export default function AdminLogin() {
  ...
  useEffect(() => {
    ...
    // Start heartbeat, stop automatically after animation ends (~2.5 s)
    const stop = startHeartbeatLoop(62)
  ...
  return (
    <div className="min-h-screen bg-[#3a1c1e] flex flex-col items-center justify-center p-4 relative overflow-hidden">
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-1/3 left-1/2 -translate-x-1/2 w-96 h-96 bg-red-900/8 rounded-full blur-3xl" />
      </div>
      ...
      >
        <div className="text-center mb-8">
          <motion.div
            ...
            className="text-6xl text-red-800 mb-4 inline-block"
            style={{ textShadow: '0 0 30px rgba(180,0,0,0.7)', fontFamily: 'Share Tech Mono, monospace' }}
          >
            ◯
          </motion.div>
          <h1 className="text-2xl text-[#c8bfbf] tracking-[0.2em]" style={{ fontFamily: 'Special Elite, cursive' }}>STAFF PORTAL</h1>
          <p className="text-[10px] tracking-[0.4em] text-[#d4b8b8] uppercase mt-2" style={{ fontFamily: 'Share Tech Mono, monospace' }}>AUTHORIZED PERSONNEL ONLY</p>
        </div>
